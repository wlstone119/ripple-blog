...
public class Reply {
	...
	/*
	 * 
	 * { id: 1, img: im, replyName: "帅大叔", beReplyName: "匿名", content:
	 * "同学聚会，看到当年追我的屌丝开着宝马车带着他老婆来了，他老婆是我隔壁宿舍的同班同学，心里后悔极了。", time:
	 * "2017-10-17 11:42:53", address: "深圳", osname: "", browse: "谷歌", replyBody: []
	 * }, { id: 2, img: im, replyName: "匿名", beReplyName: "", content:
	 ...
	 * replyBody: [] }, { id: 3, img: im, replyName: "帅大叔", beReplyName: "匿名",
	 * content: "同学聚会，看到当年追我的屌丝开着宝马车带着他老婆来了，他老婆是我隔壁宿舍的同班同学，心里后悔极了。", time:
	 * "2017-10-17 11:42:53", address: "深圳", osname: "win10", browse: "谷歌",
	 * replyBody: [] }
	 * 
	 */
