...
import com.ripple.blog.infrastructure.dao.PostDao;
...
public class PostServiceImpl implements PostService {
	...
	public PageResult<PostEntity> find(PostQuery iquery, Page page) {
		...
		Set<String> ids = postEntityPageResult.getDataList().stream().map(PostEntity::getId)
		...
		List<PostEntity> lastEntity = dataList.stream().peek(key -> {
	...
	public List<PostEntity> findHotPostBeforeTen() {
		...
		Map<String, Long> collect = hotCount.stream()
