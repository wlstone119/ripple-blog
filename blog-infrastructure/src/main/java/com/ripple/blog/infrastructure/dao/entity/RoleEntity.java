...
@Indexes({ @Index(name = "N_T_P_S", fields = { @Field(value = RoleEntity.Fields.ename),
		@Field(value = RoleEntity.Fields.parentRoleId), @Field(value = RoleEntity.Fields.status) }) })
public class RoleEntity extends BaseEntity {
	...
	public static RoleEntity create(AuthContext authContext, String cname, String ename, String remark, String status,
			List<Permission> permission, List<String> userIds) {
