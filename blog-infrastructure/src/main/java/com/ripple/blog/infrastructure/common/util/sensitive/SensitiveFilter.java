package com.ripple.blog.infrastructure.common.util.sensitive;
...
public class SensitiveFilter implements Serializable {
	...
	public static final SensitiveFilter DEFAULT = new SensitiveFilter(new BufferedReader(
			new InputStreamReader(ClassLoader.getSystemResourceAsStream("sensi_words.txt"), StandardCharsets.UTF_8)));
	 ...
	 */
	private SensitiveFilter(BufferedReader reader) {
		try {
