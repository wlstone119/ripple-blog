...
/**
 * desc: version: 6.7 Created by cuiyongxu on 2019/9/1 12:28 AM
 */
@Data
@Entity(value = "FileUpload", noClassnameStored = true)
@ToString(callSuper = true)
@Indexes({ @Index(name = "FU_MD5", fields = { @Field(value = FileUploadEntity.Fields.md5), }) })
public class FileUploadEntity extends BaseEntity {
	...
	public static FileUploadEntity create(FileType uploadType, String fileName, String newFileName, String md5,
			String suffixName, String ctx, AuthContext context) {
