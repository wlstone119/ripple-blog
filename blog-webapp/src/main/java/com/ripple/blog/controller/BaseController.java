...
public class BaseController {
	...
	private List<Post> getHotPosts() {
		...
		return serviceHotPost.stream().map(Post::createSimple)
				.sorted((o1, o2) -> o1.getViews() > o2.getViews() ? -1 : 1).collect(Collectors.toList());
	}
	...
	protected void generateVerification(HttpServletResponse response, HttpSession session, String varCodeKey,
			String varCodeTime) throws IOException {
