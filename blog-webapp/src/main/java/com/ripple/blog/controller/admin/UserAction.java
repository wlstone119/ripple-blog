...
import com.ripple.blog.controller.admin.model.BaseUserInfo;
import com.ripple.blog.controller.admin.model.Contact;
import com.ripple.blog.controller.admin.model.UpdPassword;
import com.ripple.blog.controller.admin.model.WebSet;
...
public class UserAction extends BaseController {
	...
	public Result editPassword(HttpServletRequest request, HttpSession session, @RequestBody UpdPassword updPassword) {
		...
		Result result = VerifyCodeUtils.validImage(updPassword.getPwdVerCode(), verCode, request, session,
				updPwdCodeKey, updPwdCodeTime);
		if (result.getCode() != 0) {
